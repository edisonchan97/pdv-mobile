        ...
        <ReactCSSTransitionGroup
          ...
          transitionLeaveTimeout={300}>
          {
            ...
            <aside key='nav-slide' className="nav-slide-list" onClick={this.toggleNav}>
              ...
              {
                !this.props.userData.isLogin && <NavLink to="/login" exact className="nav-link icon-jiantou-copy-copy">登录</NavLink>
              }
                   {
                this.props.userData.isLogin && <NavLink to="/userCenter" exact className="nav-link icon-jiantou-copy-copy">用户中心</NavLink>
              }
            </aside>
          }
        </ReactCSSTransitionGroup>
